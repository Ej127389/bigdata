...
public class task5 {
    ...
    public static class Task5Map extends Mapper<Object, Text, Text, Text> {
        ...
        protected void map(Object key, Text value, Context context) throws IOException, InterruptedException {
            ...
            while (itr.hasMoreTokens()) {
                ...
                String agent = weblog.getHttp_user_agent();
                keyInfo.set(agent);
                valueInfo.set("1");
    ...
    public static class Task5Combine extends Reducer<Text, Text, Text, Text> {
        private Text valueInfo = new Text();
        // 实现reduce函数
    ...
    private static class Task5Reducer extends Reducer<Text, Text, Text, Text> {
        private Text valueInfo = new Text();
