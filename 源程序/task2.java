...
public class task2 {
    ...
    public static class Task2Map extends Mapper<Object, Text, Text, Text> {
    ...
    public static class Task2Combine extends Reducer<Text, Text, Text, Text> {
        private Text valueInfo = new Text();
        // 实现reduce函数
    ...
    private static class Task2Reducer extends Reducer<Text, Text, Text, Text> {
        private Text valueInfo = new Text();
    ...
    public static void main(String[] args) throws Exception {
        ...
        job.setCombinerClass(Task2Combine.class);
